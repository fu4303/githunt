...
export default (props) => (
    <svg {...props} viewBox="0 0 1024 1024" version="1.1" width="64" height="64">
        ...
        <path d="M736 512a224 224 0 1 0-448 0 224 224 0 1 0 448 0z" fill="#ea856e" p-id="inner-circle"></path>
        <path d="M512 109.248L626.752 224H800v173.248L914.752 512 800 626.752V800h-173.248L512 914.752 397.248 800H224v-173.248L109.248 512 224 397.248V224h173.248L512 109.248M512 64l-128 128H192v192l-128 128 128 128v192h192l128 128 128-128h192v-192l128-128-128-128V192h-192l-128-128z" fill="#cecc39" p-id="outer-line"></path>
